...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center gap-1.5 rounded-full border-2 border-transparent bg-clip-padding text-sm font-bold uppercase whitespace-nowrap transition-all duration-200 outline-none select-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "border-foreground bg-primary text-foreground hover:bg-primary-hover",
        outline:
        ...
        link: "border-transparent text-foreground underline-offset-4 hover:underline rounded-none uppercase font-bold",
      },
      size: {
        default:
        ...
        lg: "min-h-[44px] gap-2 px-6 py-3 text-sm has-data-[icon=inline-end]:pr-5 has-data-[icon=inline-start]:pl-5",
        icon: "size-10",
